            ...
            <div
                ...
                <div class="p-5 flex flex-col flex-1">
                    ...
                    <div class="text-gray-400 text-sm space-y-1">
                        ...
                        <p><i class="fa-solid fa-money-bill mr-1 text-green-400"></i> Rp {{ number_format($k->harga, 0, ',', '.') }}</p>
                        ...
                        <p><i class="fa-solid fa-tag mr-1 text-blue-400"></i> Harga Setelah Diskon:
                            <span class="font-medium text-gray-100">Rp {{ number_format($k->harga_diskon, 0, ',', '.') }}</span>
                        </p>
                        <p><i class="fa-solid fa-box mr-1 text-purple-400"></i> Paket: {{ $k->tipe_paket ?? 'General' }}</p>
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 mt-5">
                        <button
                            ...
                            data-paket="General" data-deskripsi="{{ $k->deskripsi }}"
...
<div id="modal{{ $modalId }}"
    ...
    <div class="bg-gray-800 text-gray-200 rounded-2xl w-full max-w-lg border border-gray-700 shadow-2xl animate-fadeIn flex flex-col max-h-[90vh]">
            ...
            <form action="{{ $modalId === 'Create' ? route('kelas.store') : '' }}" method="POST"
                ...
                <div>
                    ...
                    <input type="text" name="nama_kelas" id="{{ strtolower($modalId) }}Nama"
                        class="w-full bg-gray-900 border border-gray-700 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 outline-none" required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="kapasitas" id="{{ strtolower($modalId) }}Kapasitas"
                        class="w-full bg-gray-900 border border-gray-700 rounded-md px-3 py-2 text-sm" value="20" min="1" required>
                </div>
