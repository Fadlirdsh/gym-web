    ...
    <div class="min-h-screen bg-gray-900 text-gray-100 px-6 py-8">
        ...
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mb-8">
                <h1 class="text-3xl font-bold text-white tracking-wide">💰 Manajemen Diskon</h1>
                    ...
                    <tbody class="divide-y divide-gray-700">
                        @forelse($diskons as $diskon)
                            <tr class="text-center hover:bg-gray-700/40 transition">
                                ...
                                <td class="px-3 py-2">
                                    <span
                                        class="inline-block bg-blue-700/30 text-blue-400 border border-blue-600 px-3 py-1 rounded-full text-xs font-semibold">
                                        {{ $diskon->persentase }}%
                                    </span>
                                </td>
                                <td class="px-3 py-2">{{ \Carbon\Carbon::parse($diskon->tanggal_mulai)->format('d M Y') }}
                                </td>
                                <td class="px-3 py-2">
                                    {{ \Carbon\Carbon::parse($diskon->tanggal_berakhir)->format('d M Y') }}</td>
                ...
                <div class="bg-gray-800 text-gray-100 rounded-2xl shadow-2xl w-96 p-6 border border-gray-700">
                    ...
                    <form action="{{ route('diskon.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="kelas_id" class="w-full bg-gray-900 border border-gray-700 rounded-lg px-3 py-2">
                                @foreach ($kelas as $k)
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_diskon"
                                class="w-full bg-gray-900 border border-gray-700 rounded-lg px-3 py-2" required>
                        </div>
            ...
            {{-- MODAL EDIT --}}
            {{-- ============= --}}
            <div id="modalEdit" class="fixed inset-0 bg-black/70 backdrop-blur-sm items-center justify-center z-50 hidden">
                <div class="bg-gray-800 text-gray-100 rounded-2xl shadow-2xl w-96 p-6 border border-gray-700">
